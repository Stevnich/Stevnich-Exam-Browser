...
namespace SebWindowsConfig
{
	public class SEBSettings
	{
		...
		public static void CreateDefaultAndCurrentSettingsFromScratch()
		{
			...
			SEBSettings.settingsDefault.Add(SEBSettings.KeyStartURL, "https://smaswastasantothomas2medan.isch.id/student-go/student_login");
			...
			SEBSettings.settingsDefault.Add(SEBSettings.KeyTaskBarHeight, 10);
			...
			SEBSettings.settingsDefault.Add(SEBSettings.KeyAudioVolumeLevel, 0);
			...
			SEBSettings.settingsDefault.Add(SEBSettings.KeyAllowSwitchToApplications, true);
			...
			SEBSettings.settingsDefault.Add(SEBSettings.KeyAllowScreenSharing, true);
			...
			SEBSettings.settingsDefault.Add(SEBSettings.KeyAllowApplicationLog, true);
			...
			SEBSettings.settingsDefault.Add(SEBSettings.KeyMinMacOSVersion, 10);
			...
			SEBSettings.settingsDefault.Add(SEBSettings.KeyAllowSiri, true);
			SEBSettings.settingsDefault.Add(SEBSettings.KeyAllowDictation, true);
			SEBSettings.settingsDefault.Add(SEBSettings.KeyDetectStoppedProcess, true);
			SEBSettings.settingsDefault.Add(SEBSettings.KeyAllowDisplayMirroring, true);
			SEBSettings.settingsDefault.Add(SEBSettings.KeyAllowedDisplaysMaxNumber, 1000);
			SEBSettings.settingsDefault.Add(SEBSettings.KeyAllowedDisplayBuiltin, false);
			...
			SEBSettings.settingsDefault.Add(SEBSettings.KeyClipboardPolicy, 0);
			...
			SEBSettings.settingsDefault.Add(SEBSettings.KeyAllowStickyKeys, true);

			// Default selected index and string in combo box for minMacOSVersion 
			SEBSettings.intArrayDefault[SEBSettings.ValMinMacOSVersion] = 10;
			SEBSettings.strArrayDefault[SEBSettings.ValMinMacOSVersion] = "macOS 12 Monterey";
			...
			SEBSettings.settingsDefault.Add(SEBSettings.KeyInsideSebEnableSwitchUser, true);
			...
			SEBSettings.settingsDefault.Add(SEBSettings.KeyHookKeys, false);
