...
namespace SafeExamBrowser.WindowsApi.Contracts
{
	...
	public interface INativeMethods
	{
		...
		/// <summary>
		/// Deregisters all currently registered keyboard hooks. This is used to
		/// ensure that no low-level keyboard hooks are active (for example when the
		/// application wants to allow system app switching globally).
		/// </summary>
		void DeregisterAllKeyboardHooks();
