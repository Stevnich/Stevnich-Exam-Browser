...
if (typeof onCopy === 'undefined') {
    // Do not intercept copy events - allow native clipboard behavior
	function onCopy(e) {
		return true;
	}
}
...
if (typeof onCut === 'undefined') {
    // Do not intercept cut events - allow native clipboard behavior
	function onCut(e) {
		return true;
	}
}
...
if (typeof onPaste === 'undefined') {
    // Do not intercept paste events - allow native clipboard behavior
	function onPaste(e) {
		return true;
	}
}
