...
namespace SafeExamBrowser.WindowsApi.Desktops
{
	public class DesktopMonitor : IDesktopMonitor
	{
		...
		{
            // Desktop monitoring is disabled to avoid reacting to desktop
			// switches or attempting to activate alternate desktops.
			logger.Debug("DesktopMonitor timer fired but monitoring is disabled in this build.");
			timer.Start();
		}
	}
}
